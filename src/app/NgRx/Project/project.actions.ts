...
export const addProject = createAction('[Project] Add Project', props<{ project: ProjectModel }>());
...
export const updateProject = createAction('[Project] Update Project', props<{ projectId: string, project: ProjectModel }>());
